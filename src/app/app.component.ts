...
import { ClientSideMultipleSelectionConfig, ClientSideSingleSelectionConfig, SelectedFilterDisplayValuesType, SelectedFilterDisplayValueType, ServerSideMultipleSelectionConfig, ServerSideSingleSelectionConfig, AngularSearchAndSelectDropdownModule } from 'angular-search-and-select-dropdown';

@Component({
  selector: 'app-root',
  imports: [CommonModule, ReactiveFormsModule, AngularSearchAndSelectDropdownModule],
  templateUrl: './app.component.html',
  styleUrl: './app.component.scss'
})
export class AppComponent {
  title = 'angular-search-and-select-dropdown-project';
  form!: FormGroup;
  options1: any[] = [
    {
      "id": "628",
  ...
  config = {
    ...
    singleClientSideSelectWithTags: <ClientSideSingleSelectionConfig>{
      ...
      badge: {
        key: 'residentTypes',
        classConditionList: [
          { key: 1, value: "Owner", class: 'angular-badge-outline-primary' },
          { key: 2, value: "Resident", class: 'angular-badge-outline-success' },
          { key: 3, value: "Tenant", class: 'angular-badge-outline-accent' },
        ]
      }
    }
  }
