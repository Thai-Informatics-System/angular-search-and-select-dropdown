...
@Component({
  selector: 'angular-client-side-dropdown',
  standalone: false,
  templateUrl: './angular-client-side-dropdown.component.html',
  styleUrl: './angular-client-side-dropdown.component.css',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AngularClientSideDropdownComponent),
      multi: true
    }
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AngularClientSideDropdownComponent {
