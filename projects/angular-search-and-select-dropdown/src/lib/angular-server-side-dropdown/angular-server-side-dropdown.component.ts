...
@Component({
  selector: 'angular-server-side-dropdown',
  standalone: false,
  templateUrl: './angular-server-side-dropdown.component.html',
  styleUrl: './angular-server-side-dropdown.component.css',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AngularServerSideDropdownComponent),
      multi: true
    }
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AngularServerSideDropdownComponent {
